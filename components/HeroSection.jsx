...
const stats = [
  ...
  return (
    <section className="relative min-h-screen flex flex-col justify-center items-center text-center px-4 bg-[url('/main-bg.jpg')] bg-cover bg-no-repeat bg-center">
      {/* Overlay */}
      ...
      <div className="relative z-10 max-w-4xl">
        <h1 className="text-white text-4xl sm:text-5xl md:text-6xl font-bold leading-tight">
          BUILDING THE <span className="bg-gradient-to-r from-yellow-400 via-orange-400 to-pink-500 text-transparent bg-clip-text">FUTURE</span><br />
          FOR SPORTS PLAYERS
        </h1>
